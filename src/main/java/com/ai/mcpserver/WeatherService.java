...
public class WeatherService {
    ...
    /**
     * 获取特定地区的天气警报
     * @param state 地区代码。美国州的两字母代码（例如 CA, NY）
     * @return 可读的警报信息
     * @throws RestClientException 如果请求失败
     */
    @Tool(description = "获取美国州的天气警报。输入为两字母的美国州代码（例如 CA, NY）")
    public String getAlerts(@ToolParam( description =  "两字母的美国州代码（例如 CA, NY）") String state) {
